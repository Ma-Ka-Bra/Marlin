...
#define STRING_CONFIG_H_AUTHOR "(Ma-Ka-Bra, Sapphire Pro)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    //Sapphire Pro autotune on Ma-Ka-Bra: M303 E0 S200 C8
    #define DEFAULT_Kp 26.63
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Sapphire Pro autotune on Ma-Ka-Bra
  #define DEFAULT_bedKp 56.62
  #define DEFAULT_bedKi 10.72
  #define DEFAULT_bedKd 199.34
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2500, 2500, 100, 2000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, 0, -1.4 }
...
#define PREHEAT_4_TEMP_HOTEND 247
